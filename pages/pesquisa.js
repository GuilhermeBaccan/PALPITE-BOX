    ...
    return (
        <div className='pt-6'>
            ...
            <p className='text-center mb-6'>
                O restaurante x sempre busca melhor atender seus clientes.<br />
            ...
            {!sucess && <div className='w-1/5 mx-auto'>
                ...
                <button className='bg-blue-400 px-8 py-4 font-bold rounded-lg shadow-lg hover:shadow' onClick={save}>Salvar</button>
            </div>}
            ...
            {sucess && <div className='w-1/5 mx-auto'>
...

                {
                    retorno.showCoupon && <div className=' text-center border p-4 mb-4'>
                        ...
                        <br />
                        <span className='italic'>Tire uma foto ou print dessa tela e apresente ao garçon.</span>
                    </div>
                }
